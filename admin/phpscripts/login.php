	...
	function logIn($username, $password, $ip) {
		...
		if(mysqli_num_rows($user_set)){
			...
			if(mysqli_query($link, $loginstring)){
				...
				$saveLast = "UPDATE tbl_user SET user_last_login='{$currentLogin}' WHERE user_id = {$id}";
...
//Makes it so if they haven't logged in yet, aka if their last login field was not updated, then go to edit page. If not, just go to index.
//No tutorial
