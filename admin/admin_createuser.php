...
<html class="no-js" lang="en">
  ...
  <body id="adminIndex">
	...
	<form action="admin_createuser.php" method="post">
		...
		<input type="text" name="fname" value="<?php if(!empty($email)){echo $fname;} ?>">

		<label>Username:</label>
		<input type="text" name="username" value="<?php if(!empty($email)){echo $username;} ?>">
		...
		<select name="lvllist">
			...
			<option value="3">Web Janitor</option>
		</select>
