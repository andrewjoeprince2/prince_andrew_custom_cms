...
<html class="no-js" lang="en">
  ...
  <title>Dashboard - Evil Corp Movies</title>
  </head>
  ...
  <body id="adminIndex">
	...
	<div class="small-12 columns fadeIn one">
		<p>Welcome to Evil Corp Movies' admin panel. From here, you can do a variatey of tasks such as add and edit movies in the database, and manage admin users.</p>
		</div>
	</div>
